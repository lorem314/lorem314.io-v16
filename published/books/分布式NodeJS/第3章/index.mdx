...
import { Tip, Note, Warning, BorderBox } from '#elements/oreilly'
...
<CodeBlock id="3-1" title="recipe-api/producer-http-basic-master.js">
...
<CodeBlock id="3-2" title="cluster-fibonacci.js">
...
<CodeBlock id="3-3" title="haproxy/stats.cfg">
...
<CodeBlock id="3-4" title="web-api/consumer-http-healthendpoint.js">
...
<CodeBlock id="3-5" title="haproxy/load-balance.cfg">
...
<CodeBlock id="3-6" title="haproxy/compression.cfg">
...
<CodeBlock id="3-7" title="生成.pem文件">
...
<CodeBlock id="3-8" title="haproxy/tls.cfg">
...
<CodeBlock id="3-9" title="low-connections.js">
...
<CodeBlock id="3-10" title="haproxy/backpressure.cfg">
...
<CodeBlock id="3-11" title="benchmark/native-http.js">
...
<CodeBlock id="3-12" title="haproxy/benchmark-basic.cfg">
...
<CodeBlock id="3-13" title="haproxy/passthru.cfg">
...
<Table id="3-9" title="本机 NodeJS TLS 终止吞吐量">
  <Thead ths={["统计数据", "1%", "2.5%", "50%", "97.5%", "平均", "标准差", "最小值"]} />
  <Tbody>
    <Tr tds={["个请求/秒", "7,263", "11,991", "13,231", "18,655", "13,580.7", "1,833.58", "7,263"]} />
    <Tr tds={["比特/秒", "2.75 MB", "4.53 MB", "5 MB", "7.05 MB", "5.13 MB", "693 kB", "2.75 MB"]} />
  </Tbody>
</Table>
...
<CodeBlock id="3-14" title="haproxy/fibonacci.cfg">
